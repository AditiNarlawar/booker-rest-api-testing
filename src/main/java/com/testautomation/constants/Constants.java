package com.testautomation.constants;
...
public class Constants {
    ...
    public static final String PROJECT_NAME = "REST Assured API Testing";
    public static final String REPORT_TITLE = "REST Assured API Testing";
